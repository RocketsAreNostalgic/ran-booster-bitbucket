...
- RAN Booster is required. This add-on supports exactly Provider API `5`, Logging API `1`, and the official-suite Add-on API `7` generation, WordPress 7.0+, and PHP 8.3+; PHP 8.4 is recommended, not required.
