...
- RAN Booster is required. This add-on supports exactly Provider API `10` and the official-suite Add-on API `15` generation, WordPress 7.0+, and PHP 8.2+; PHP 8.4 is recommended, not required.
