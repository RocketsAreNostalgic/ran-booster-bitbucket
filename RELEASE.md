...
8. Attach the verified ZIP and checksum to the private GitHub release after repository ownership, Actions access, and any required read token are provisioned.
