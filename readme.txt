...
Bitbucket Cloud provider and operational guide for the coordinated RAN Booster Add-on API 12 generation.
...
Booster Provider API 6, Logging API 1 or Add-on API 12 is absent or incompatible.
