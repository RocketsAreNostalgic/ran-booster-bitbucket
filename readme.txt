...
Bitbucket Cloud provider and operational guide for the coordinated RAN Booster Add-on API 7 generation.
...
Booster Provider API 5, Logging API 1 or Add-on API 7 is absent or incompatible.
