...
Provider API 5 and Logging API 1 contracts. It requires the coordinated Add-on
...
- Requires WordPress 7.0+, PHP 8.3+ (PHP 8.4 recommended), and compatible RAN Booster Provider API 5, Logging API 1 and Add-on API 7.
